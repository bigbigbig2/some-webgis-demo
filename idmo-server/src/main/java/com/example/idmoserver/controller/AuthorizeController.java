...
@Tag(name = "登录校验相关", description = "包括用户登录、注册、验证码请求等操作。")//Swagger的注解，用于API文档生成，描述了这个控制器的功能
public class AuthorizeController {

    @Resource //自动注入AccountService服务类的实例。
    AccountService accountService;

    /**
     * 请求邮件验证码
     * @param email 请求邮件
     * @param type 类型(重置密码、注册）
     * @param request 请求
     * @return 是否请求成功
     */
    @GetMapping("/ask-code")
    @Operation(summary = "请求邮件验证码") //描述了这个API的功能
